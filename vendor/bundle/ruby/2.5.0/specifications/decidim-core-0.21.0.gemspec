...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<foundation-rails>.freeze, ["~> 6.4", "< 6.5"])
    ...
    s.add_runtime_dependency(%q<pg>.freeze, ["~> 1.1.4", "< 2"])
    ...
    s.add_runtime_dependency(%q<rails>.freeze, [">= 5.2", "< 6.0.x"])
    ...
    s.add_runtime_dependency(%q<sassc>.freeze, ["~> 1.12", ">= 1.12.1"])
    s.add_runtime_dependency(%q<sassc-rails>.freeze, ["~> 1.3"])
    s.add_runtime_dependency(%q<seven_zip_ruby>.freeze, ["~> 1.2", ">= 1.2.2"])
    s.add_runtime_dependency(%q<social-share-button>.freeze, ["~> 1.2", ">= 1.2.1"])
    s.add_runtime_dependency(%q<spreadsheet>.freeze, ["~> 1.2"])
    s.add_runtime_dependency(%q<sprockets>.freeze, ["~> 3.7", "< 4"])
    ...
    s.add_dependency(%q<foundation-rails>.freeze, ["~> 6.4", "< 6.5"])
    ...
    s.add_dependency(%q<pg>.freeze, ["~> 1.1.4", "< 2"])
    ...
    s.add_dependency(%q<rails>.freeze, [">= 5.2", "< 6.0.x"])
    ...
    s.add_dependency(%q<sassc>.freeze, ["~> 1.12", ">= 1.12.1"])
    s.add_dependency(%q<sassc-rails>.freeze, ["~> 1.3"])
    s.add_dependency(%q<seven_zip_ruby>.freeze, ["~> 1.2", ">= 1.2.2"])
    s.add_dependency(%q<social-share-button>.freeze, ["~> 1.2", ">= 1.2.1"])
    s.add_dependency(%q<spreadsheet>.freeze, ["~> 1.2"])
    s.add_dependency(%q<sprockets>.freeze, ["~> 3.7", "< 4"])
